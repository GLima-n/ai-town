...
export default function Home() {
  ...
  return (
    <main className="relative flex h-screen w-screen flex-col items-center justify-between font-body game-background overflow-hidden">
      <ReactModal
      ...
      <div className="w-full h-full relative isolate overflow-hidden flex flex-col justify-start">
        <Game />

        <footer className="absolute bottom-0 left-0 w-full flex items-center mt-4 gap-3 p-6 flex-wrap pointer-events-none z-10 justify-end">
